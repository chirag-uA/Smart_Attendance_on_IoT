...
void connecthost(String data, int enroll)
{
  if (flag == 0)
  {
    member = data;
    ...
    url += "devid=";
    url += "vE5E3DB3BBB091E7";
    url += "&Name=" + String(member) + "&Enroll=" +String(enroll) + String(1500) + String(4917);
